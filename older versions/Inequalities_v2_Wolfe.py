...
def Inequality(Graph, inflation_order, card, Sol, b, SpMatrix, initial_epsilon):
    Comp = Compatibility(Sol, b, initial_epsilon)
    if Comp == False:
...
# Graph=TriangleGraph
# IS=Inequality(Graph,inflation_order,card,Sol,b,SpMatrix,1000*epsilon)
